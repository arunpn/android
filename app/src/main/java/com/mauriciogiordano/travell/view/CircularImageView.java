package com.mauriciogiordano.travell.view;
...
public class CircularImageView extends ImageView
{
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (image != null) {
            ...
            //canvas.drawCircle(circleCenter, circleCenter, ((canvasSize) / 2) - 4.0f, paintBorder);
    ...
    public static Bitmap drawTextToBitmap(Context gContext, String gText, boolean highDef)
    {
        ...
        paint.setTypeface(Typeface.createFromAsset(gContext.getAssets(), "roboto_regular.ttf"));
        // text shadow
